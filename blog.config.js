...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'caohui', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '全栈开发 · 记录学习', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-website.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'caohui, 笔记, 博客', // 网站关键词 英文逗号隔开
